    ...
    while (1) {
        ...
        if (mountCount > 0 && !listed) {
            ...
            if (pressed & WPAD_BUTTON_A) {
                ...
                strcat(path, ":/");
                strcat(path, "Filme/Ultraviolet.avi");
				...
				*/
				...
				printf("Trying to get the offsets...\n");
				sleep(4);
				s32 ret = ntfs_getoffsets(path, info);
				printf("ret = %d\n", ret);
				printf("Filesize = %u\n", (u32)info->filesize);
				...
				{
					printf("%02u Offset/sector/count: %u %u %u\n", i, (u32)info->offset[i], (u32)info->sector[i], (u32)info->count[i]);
				}
